...
export default function HeroSection() {
  ...
  return (
    <Element className="relative p-8" name="home">
      <div className="flex flex-col-reverse md:flex-row gap-8 items-center">
        ...
        <div className="flex-1 space-y-8">
          ...
          >
            Your partner in building tailored digital solutions that are both
            technically sound and creatively inspired, delivering exceptional
            user experiences across the modern web ecosystem.
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-wrap gap-3 mt-4">
              {SKILLS_HIGHLIGHT.map((tech, index) => (
                <motion.span
                  key={index}
