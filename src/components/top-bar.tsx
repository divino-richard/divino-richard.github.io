...
export default function TopBar() {
  ...
  const [activeNavItem, setActiveNavItem] = useState<NavigationItem | null>(
    null,
  );
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{ duration: 0.5 }}
      >
        <span className="cursor-pointer">Richard Divino</span>
      </motion.div>
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <motion.a
            ...
            whileTap={{ scale: 0.9 }}
          >
            <AiFillGithub className="text-lg text-zinc-600 dark:text-zinc-300 hover:text-zinc-900 dark:hover:text-white transition-colors" />
          </motion.a>
          <motion.a
            ...
            whileTap={{ scale: 0.9 }}
          >
            <AiFillLinkedin className="text-lg text-zinc-600 dark:text-zinc-300 hover:text-zinc-900 dark:hover:text-white transition-colors" />
          </motion.a>
        </div>
      </motion.div>
    </div>
